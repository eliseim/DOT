"""Repeatable end-to-end acceleration benchmark for a short CTH search.
...
from dot.gui.campaign_runner import _gui_topology_survival_config
...
def main() -> None:
    ...
    result = run_campaign(
        ...
        seed=args.seed,
        topology_survival=_gui_topology_survival_config(
            campaign.topology,
            args.population,
        ),
