...
- `best_candidate_roxie_blocks.csv`: `R`, turns, conductor, and both DOT/ROXIE angles;
...
36 strands of 0.825 mm. The conductor names are the names used by the ROXIE
catalogue supplied for this benchmark.
