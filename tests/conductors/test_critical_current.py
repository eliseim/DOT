...
def test_strand_and_cable_critical_current_use_superconductor_area() -> None:
    ...
    superconductor_area_m2 = total_area_mm2 / (1.0 + 1.4) * 1.0e-6
    expected_strand_ic = jc_a_per_m2 * superconductor_area_m2
